...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Wed Feb 13 23:17:19 2013
...
SOURCES       = main.cpp \
		...
		qgraphicsprocessitem.cpp moc_mainwindow.cpp \
		moc_visualiser.cpp \
		moc_confirmkill.cpp \
		moc_info.cpp \
