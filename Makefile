...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Mon Feb 11 22:39:57 2013
...
SOURCES       = main.cpp \
		...
		viewrunning.cpp \
		systeminfo.cpp \
		viewprocessor.cpp moc_mainwindow.cpp \
		moc_visualiser.cpp \
		moc_confirmkill.cpp \
		moc_info.cpp \
...
$(TARGET): ui_mainwindow.h ui_visualiser.h ui_confirmkill.h ui_info.h ui_simulatorinit.h ui_settings.h ui_errordialog.h ui_viewrunning.h ui_systeminfo.h ui_viewprocessor.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/TaskStalker1.0.0/ && $(COPY_FILE) --parents mainwindow.h proc.h visualiser.h confirmkill.h info.h simulatorinit.h sys.h settings.h errordialog.h viewrunning.h systeminfo.h viewprocessor.h .tmp/TaskStalker1.0.0/ && $(COPY_FILE) --parents images.qrc help.qrc .tmp/TaskStalker1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp proc.cpp visualiser.cpp confirmkill.cpp info.cpp simulatorinit.cpp sys.cpp settings.cpp errordialog.cpp viewrunning.cpp systeminfo.cpp viewprocessor.cpp .tmp/TaskStalker1.0.0/ && $(COPY_FILE) --parents mainwindow.ui visualiser.ui confirmkill.ui info.ui simulatorinit.ui settings.ui errordialog.ui viewrunning.ui systeminfo.ui viewprocessor.ui .tmp/TaskStalker1.0.0/ && (cd `dirname .tmp/TaskStalker1.0.0` && $(TAR) TaskStalker1.0.0.tar TaskStalker1.0.0 && $(COMPRESS) TaskStalker1.0.0.tar) && $(MOVE) `dirname .tmp/TaskStalker1.0.0`/TaskStalker1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/TaskStalker1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_visualiser.cpp moc_confirmkill.cpp moc_info.cpp moc_simulatorinit.cpp moc_settings.cpp moc_errordialog.cpp moc_viewrunning.cpp moc_systeminfo.cpp moc_viewprocessor.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_visualiser.cpp moc_confirmkill.cpp moc_info.cpp moc_simulatorinit.cpp moc_settings.cpp moc_errordialog.cpp moc_viewrunning.cpp moc_systeminfo.cpp moc_viewprocessor.cpp
...
moc_viewprocessor.cpp: viewprocessor.h
...
compiler_uic_make_all: ui_mainwindow.h ui_visualiser.h ui_confirmkill.h ui_info.h ui_simulatorinit.h ui_settings.h ui_errordialog.h ui_viewrunning.h ui_systeminfo.h ui_viewprocessor.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_visualiser.h ui_confirmkill.h ui_info.h ui_simulatorinit.h ui_settings.h ui_errordialog.h ui_viewrunning.h ui_systeminfo.h ui_viewprocessor.h
