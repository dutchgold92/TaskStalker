...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Wed Dec 19 21:39:27 2012
...
SOURCES       = main.cpp \
		...
		info.cpp \
		simulator.cpp \
		simulatorinit.cpp moc_mainwindow.cpp \
		moc_visualiser.cpp \
		moc_confirmkill.cpp \
		moc_info.cpp \
		moc_simulator.cpp \
...
$(TARGET): ui_mainwindow.h ui_visualiser.h ui_confirmkill.h ui_info.h ui_simulator.h ui_simulatorinit.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/TaskStalker1.0.0/ && $(COPY_FILE) --parents mainwindow.h proc.h visualiser.h confirmkill.h info.h simulator.h simulatorinit.h .tmp/TaskStalker1.0.0/ && $(COPY_FILE) --parents images.qrc help.qrc .tmp/TaskStalker1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp proc.cpp visualiser.cpp confirmkill.cpp info.cpp simulator.cpp simulatorinit.cpp .tmp/TaskStalker1.0.0/ && $(COPY_FILE) --parents mainwindow.ui visualiser.ui confirmkill.ui info.ui simulator.ui simulatorinit.ui .tmp/TaskStalker1.0.0/ && (cd `dirname .tmp/TaskStalker1.0.0` && $(TAR) TaskStalker1.0.0.tar TaskStalker1.0.0 && $(COMPRESS) TaskStalker1.0.0.tar) && $(MOVE) `dirname .tmp/TaskStalker1.0.0`/TaskStalker1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/TaskStalker1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_visualiser.cpp moc_confirmkill.cpp moc_info.cpp moc_simulator.cpp moc_simulatorinit.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_visualiser.cpp moc_confirmkill.cpp moc_info.cpp moc_simulator.cpp moc_simulatorinit.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_visualiser.h ui_confirmkill.h ui_info.h ui_simulator.h ui_simulatorinit.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_visualiser.h ui_confirmkill.h ui_info.h ui_simulator.h ui_simulatorinit.h
